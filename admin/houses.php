  ...
  <div class="avl-header avl-container show-on-med-and-large hide-on-small-only">
	...
	<ul>
	  <li>
        ...
        <li>
            <a href="houserpt.php">VIEW ALL HOUSES</a>
        </li>
        <li>
...
<div class="container">
    ...
    <?php	
    $res= mysqli_query($link,"select * from houses where id = '$_POST[id]'");
    ...
    <?php	
        ...
        {
        $res= mysqli_query($link,"delete from houses where id = '$_POST[id]'");
    ?>
    <script type="text/javascript">
        alert("SUCCESS");
    </script>
