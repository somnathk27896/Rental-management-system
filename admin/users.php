  ...
  <div class="avl-header avl-container show-on-med-and-large hide-on-small-only">
	...
	<ul>
	  <li>
        ...
        <li>
            <a href="userrpt.php">VIEW ALL USERS</a>
        </li>
        <li>
...
<div class="container">
    ...
    <form name="" action="" method="post">
        <fieldset>
            ...
            <table>
                <tr>
                    <td>
                            <input type="text" name="susername" placeholder="Search By Username" >
    ...
    <?php	
    $res= mysqli_query($link,"select * from user_details where username = '$_POST[susername]'");
    ...
    <?php	
        ...
        {
        $res= mysqli_query($link,"delete from user_details where username = '$_POST[username]'");
    ?>
    <script type="text/javascript">
        alert("SUCCESS");
    </script>
